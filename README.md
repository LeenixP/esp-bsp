...
|:----------:|:---:|:-------------------|:-----:|
| [Candis-S31](bsp/candis_s31) | esp32s31 | :musical_note: Audio <br/>:microphone: Audio Microphone  (es8389)<br/>:speaker: Audio Speaker  (es8389)<br/>:battery: Battery <br/>:camera: Camera  (OV3660)<br/>:pager: LCD Display  (co5300)<br/>:bulb: LED <br/>:floppy_disk: uSD Card <br/>:point_up: Display Touch  (cst820)<br/> | - |
